...
### 4、兼容django 和 flask
### 5、更多兼容格式转换：list、set、dict、tuple均可以自动转换。还有data_format.datetime的格式转换类，可以将'2019-01-18 23:25:25'这样的字符串日期转换成日期格式。你当然也可以很方便的制作一个格式转换器
...
### [Django例子](https://github.com/pcloth/api-shop/tree/master/django_demo)
```python
## urls.py
...
### [flask例子](https://github.com/pcloth/api-shop/tree/master/flask_demo)
```python
