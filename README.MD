...
4. 兼容django 和 flask
5. 容器格式转换，data_format.datetime格式转换类；'2019-01-18 23:25:25' to datetime
6. 自定义格式转换器
7. 多国语言支持。
8. 文档支持热重载。
...
1. [Django例子](https://github.com/pcloth/api-shop/tree/master/django_demo)
```python
## urls.py
...
2. [flask例子](https://github.com/pcloth/api-shop/tree/master/flask_demo)
```python
